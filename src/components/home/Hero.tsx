      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 md:gap-6">
            <button className="px-6 py-3 md:px-10 md:py-5 bg-industrial-orange text-black text-heavy text-lg md:text-xl border-4 border-white shadow-[4px_4px_0px_white] md:shadow-[8px_8px_0px_white] active:translate-x-1 active:translate-y-1 active:shadow-none transition-all">
              DEPLOY RESOURCES
            </button>
            <button className="px-6 py-3 md:px-10 md:py-5 bg-black text-white text-heavy text-lg md:text-xl border-4 border-industrial-orange hover:bg-white hover:text-black transition-all">
              VIEW BLUEPRINTS
            </button>
          </div>
        </motion.div>
